...
export default function ArticlesSection({ isActive }: { isActive: boolean }) {
  ...
  return (
    <section
      ...
      role="region"
      aria-label="Articles"
      className="articles-section flex justify-center items-center scroll-target h-[max(720px,calc(100vh-60px))] tall:h-[calc(100vh-80px)] px-12 tall:snap-start bg-app-white-bg"
    >
